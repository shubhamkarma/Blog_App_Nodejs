...
mongoose.connect("mongodb+srv://shubhamkarma95:Maya2748@cluster0.sxzfirp.mongodb.net/?retryWrites=true&w=majority").then((conn)=>{console.log("Connected to DB")}).catch((e)=>{console.log(e)})
